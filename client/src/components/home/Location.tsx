...
const Location = () => {
  return (
    <div className='px-5 text-sm/8 font-medium mt-20 bg-center bg-cover bg-[url(/images/background-design.svg)]'>
      ...
      <p className='tracking-wide text-sm/8  text-center '>
        NeatFleet Home and Cleaning Solutions in Dallas offers top-notch cleaning services,
        delivering exceptional care to your home or office across the surrounding areas.
        <br />
        <span className='text-[#3B82F6]'>
          Trust our professional team to keep your space spotless with reliable, tailored cleaning
          and repair solutions!
        </span>{' '}
      </p>
      <div className='flex flex-col text-center text-lg justify-center sm:text-xl mb-3'>
        <img
          className='md:w-1/2 mx-auto rounded'
          src='./images/neatfleet-building.jpg'
          alt='NeatFleet Building'
        />
