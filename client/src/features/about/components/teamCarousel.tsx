...
const teamMembers = [
  {
    ...
    // experience: '6+ years',
    linkedIn: 'https://www.linkedin.com/in/faliloukhouma/',
    avatar:
  ...
  },
  {
    ...
    // email: 'sdafasd..com',
    linkedIn: 'https://www.linkedin.com/in/jesusdoza/',
    avatar:
  ...
  },
  {
    ...
    linkedIn: 'https://www.linkedin.com/in/joshuaebeck/',
  ...
  },
  {
    ...
    name: 'Justin Cloud',
    role: 'Full Stack Developer',
    linkedIn: 'https://www.linkedin.com/in/j-cloud/',
    avatar:
  ...
  },
  {
    ...
    name: 'Yassah Reed',
    role: 'Full Stack Developer',
    linkedIn: 'https://www.linkedin.com/in/yassahreed/',
    location: 'Boston, MA',
  ...
  },
  {
    ...
    name: 'Max Campos',
    role: 'Full Stack Developer',
    linkedIn: 'https://www.linkedin.com/in/maxca117/',
        ...
        <div className='relative mx-auto' style={{ width: '640px', height: '640px' }}>
          <div className='absolute inset-0 flex items-center justify-center'>
            <div className='text-center'>
              ...
              <p className='text-sm text-muted-foreground'>talented professionals</p>
            </div>
          </div>
